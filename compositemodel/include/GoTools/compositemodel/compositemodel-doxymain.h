...
\beginlink \link Go::Body\endlink is a boundary represented solid model. It is a virtual volume limited
...
to represent a face set. In addition to being a topological entity, \beginlink \link Go::SurfaceModel\endlink
...
\beginlink \link Go::ftSurface\endlink. The face represents the abstract idea of a bounded surface, but it also
has a pointer to the geometric representation of this surface. The geometric
surface is a \beginlink \link Go::ParamSurface\endlink, it may be a NURBS surface, an elementary surface 
...
holes in the surface. Then the geometric surface will always be a \beginlink \link Go::BoundedSurface\endlink. All
...
concrete tesselation results are \beginlink \link Go::LineStrip\endlink, 
\beginlink \link Go::RegularMesh\endlink and \beginlink \link Go::GenericTriMesh\endlink.
...
\beginlink \link Go::LineCloud\endlink. LineCloud is an entity in gotools-core/geometry.

\subsection comp_sec2_2 CompositeCurve
A \beginlink \link Go::CompositeCurve composite curve \endlink 
...
A composite curve will contain a number of \beginlink \link Go::ParamCurves \endlink, ordering 
...
A \beginlink \link Go::CurveModel curve model\endlink is an incomplete class 
...
A \beginlink \link Go::SurfaceModel surface model\endlink represents a surface set or a shell. 
...
given as parametric surfaces or faces, i.e. \beginlink \link Go::ftSurface\endlink. 
